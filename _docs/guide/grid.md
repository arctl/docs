...
![](/assets/images/grid_tools/add_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
Далее необходимо заполнить открывшуюся форму справочника или документа.

### Копировать
Для копирования строки используйте кнопку
![](/assets/images/grid_tools/copy_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
Далее необходимо заполнить открывшуюся форму справочника или документа.
...
![](/assets/images/grid_tools/edit_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
Далее необходимо заполнить открывшуюся форму справочника или документа.
...
![](/assets/images/grid_tools/del_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
...
-   [панели инструментов](/assets/images/work_window/#панель-инструментов)
-   [строке навигации](/assets/images/work_window/#строка-навигации).

### Фильтр
Для задания фильтрации используйте кнопку ![](/assets/images/grid_tools/filter_buttont.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
...
### Группировка
Для задания и включения панели группировки *Сгруппировано* используйте кнопку ![](/assets/images/grid_tools/group_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
...
Для задания сортировки и открытия панели сортировки *Отсортировано* используйте кнопку *Сортировка* ![](/assets/images/sorting.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов)
таблицы.
...
Для отмены сортировки по всем выбранным колонкам используйте кнопку ![](/assets/images/grid_tools/group_cancel_all_button.png),
расположенную в правой части кнопки *Сортировка*.

Выберите и нажмите кнопку *Очистить* ![](/assets/images/grid_tools/group_clear_button.png).

### Выгрузка
Для выгрузки используйте кнопку ![](/assets/images/upload_button.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
...
### Автор
Для определения автора используйте кнопку ![](/assets/images/author.png) на [панели инструментов](/assets/images/work_window/#панель-инструментов).
