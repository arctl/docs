...
Для изменения порядка следования колонок необходимо захватить заголовок нужной колонки и, удерживая нажатой левую кнопку мыши, перетащить его в нужное место до появления серых стрелочек. Затем отпустить кнопку мыши.
