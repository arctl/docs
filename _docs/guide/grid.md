...
Например, параллельная работа со записью двух и более сотрудников.
Для обновления используйте кнопку
![](../../images/grid_tools/refresh_button.png).

Кнопка располагается в [рабочем окне](../work_window):
...
Откроется панель фильтров.

![](../../images/grid_tools/rowe_filters.png)

Строки [рабочей таблицы](../work_window) фильтруются по условию совпадения значений.
...
Для вызова настриваемого фильтра используйте ![](../../images/grid_tools/arrow.png)
...
-   Нажмите на заголовок колонки, по которой требуется отсортировать строки.
После нажатия на заголовке должен появиться значок ▽ (по возратаниию) или △ (по убыванию).

![](../../images/sorting_column.png)

-   Вызовите контекстное меню заголовка колонки, нажав левой кнопкой мыши на правую часть заголовка колонки,
...
-   Сортируйте содержимое колонок через меню *Сортировка* панели управления.
