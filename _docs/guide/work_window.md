...
Основное *Рабочее окно* системы содержит открытые поользователем вкладки
...
данные справочника или документы.
...
![](../../images/grid_tools/rowindicator.png) и выделяется фоновым цветом строки.
