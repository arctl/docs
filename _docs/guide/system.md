...
Для работы в системе необходимо запустите веб-браузер.
...
### Аутентификация
Для начала работы в системе пройдите процесс аутентификации.
Для этого на стартовой странице необходимо заполните поля *Логин*, *Пароль*, полученные при регистрации в системе, и нажмите кнопку *Войти*.
...
в [рабочем окне](work_window.md) откроется вкладка, содежаржащая в табличном виде:
