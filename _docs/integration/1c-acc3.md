...
далее обмен выполняется используя это код. Изменяя код в 1С нарушается связь.
...
**АРК: Транспортная Логистика обмен с сайтом arctl.ru**
всегда находится по адресу: [Яндекс Диск](https://yadi.sk/d/yPQwBFdNiH0Ssg).
...
Откройте раздел раздел *Продажи*, *Покупки* или *Банк и касса*,
затем перейдите в меню *Дополнительные обработки*.

![](../../images/service_file.png)

Длаее открыть обработку **АРК: Транспортная Логистика обмен с сайтом arctl.ru**

![](../../images/my_additional_processing.png)

### Через файл
Откройте меню *Файл*, затем в меню *Открыть*
выбрать путь к загруженной обработке

![](../../images/open_file.png)

### Через сохраненный путь
Запуск возможен если раннее обработак открывалась *Через файл*.
...
В названии указать “Синхронизация данных с АРК”.
