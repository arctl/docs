...
В разделах *Продажи*, *Покупки*, *Банк и касса* (раздел определяет администратор)
используйте меню *Дополнительные обработки*.
...
Через меню *Файл*, затем *Открыть* выберите путь к загруженной обработке

![](../../images/open_file.png)

### Через сохраненный путь

Если ранее открывали обработку, через меню *Файл* выберите сохраненный путь
