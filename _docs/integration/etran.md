...
1. У пользователя должна быть роль `MR - Диспетчирование \ ЭТРАН Электронные сервисы`
...
## Как добавить задачу для выполнения 

Нужно создать задачу в `Администрирование \ Планировщик задач`
...
Затем нажать далее и подтвердить создание задани