...
| ------------ | ----------------------------------------- | ------------------------------------------------------------------- |
| Для заявки   | Отображение пункта для менеджера в заявке | Можно использовать для отображения технологического пункта в заявке |
